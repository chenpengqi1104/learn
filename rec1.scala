...
object rec1{
  ...
  //定义一个待分解的矩阵
  val m1 = DenseMatrix((1.0,2.0,5.0,3.2),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(2.9,4.0,3.8,4.5)
    ,(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5)
    ,(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5)
    ,(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5)
    ,(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5)
    ,(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5),(4.5,4.1,5.0,3.5),(2.9,4.0,3.8,4.5)
  ...
  //随机初始化分解后的两个矩阵m2,m3
  var m2= DenseMatrix((1.2,0.3),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1)
    ,(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(0.4,1.1),(2.1,1.2),(0.4,1.1)
    ,(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(0.4,1.1),(2.1,1.2),(0.4,1.1)
    ,(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(0.4,1.1),(2.1,1.2),(0.4,1.1)
    ,(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1),(2.1,1.2),(0.4,1.1)
  )
  var m3=DenseMatrix((2.1,3.4,1.1,1.6),(1.3,2.1,1.2,1.1))
  ...
  val predictM = DenseMatrix.zeros[Double](rows,cols) //m2,m3的乘积矩阵，也就是预测矩阵
  ...
  def main(args: Array[String]): Unit = {
      ...
      val b=Recommend(1,1)//向用户1推荐评分top(1)的商品
  ...
  def Recommend(uid:Int,num:Int):String={ //向用户uid推荐num个评分可能最高的商品
    val i=uid-1
    var res=0.0
    var str=""
    var max=0.0
